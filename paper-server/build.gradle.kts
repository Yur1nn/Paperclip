...
tasks.jar {
    manifest {
        ...
        val buildTime = System.getenv("BUILD_STARTED_AT")?.let(Instant::parse) ?: Instant.now()
        ...
        attributes(
            ...
            "Implementation-Title" to "Paperclip",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "Paperclip",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "Paperclip Team",
            "Brand-Id" to "papermc:paper",
            "Brand-Name" to "Paperclip",
